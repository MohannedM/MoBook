...
<div class="form-shadow mt-4">
    <form class="form-signin" action="<?php echo URLROOT . '/posts/add'; ?>" method="post" enctype="multipart/form-data">
        ...
        <input type="submit" value="Add Post" class="btn btn-lg btn-primary">
    </form>
</div>
